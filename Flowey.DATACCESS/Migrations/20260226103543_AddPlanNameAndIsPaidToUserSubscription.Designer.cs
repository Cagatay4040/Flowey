...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20260226103543_AddPlanNameAndIsPaidToUserSubscription")]
    partial class AddPlanNameAndIsPaidToUserSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 2, 26, 13, 35, 42, 853, DateTimeKind.Local).AddTicks(1802),
                            IsActive = true,
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            Code = "EDITOR",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 26, 13, 35, 42, 853, DateTimeKind.Local).AddTicks(1812),
                            IsActive = true,
                            Name = "Editor"
                        },
                        new
                        {
                            ...
                            Code = "MEMBER",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 26, 13, 35, 42, 853, DateTimeKind.Local).AddTicks(1813),
                            IsActive = true,
                            Name = "Member"
                        });
                });
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.UserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.UserNotification", b =>
                {
                    b.HasOne("Flowey.DOMAIN.Model.Concrete.User", "SenderUser")
                        .WithMany()
