...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20260228111839_TaskHistoryUserIdColumnNullable")]
    partial class TaskHistoryUserIdColumnNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 2, 28, 14, 18, 38, 806, DateTimeKind.Local).AddTicks(2878),
                            IsActive = true,
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            Code = "EDITOR",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 28, 14, 18, 38, 806, DateTimeKind.Local).AddTicks(2887),
                            IsActive = true,
                            Name = "Editor"
                        },
                        new
                        {
                            ...
                            Code = "MEMBER",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 28, 14, 18, 38, 806, DateTimeKind.Local).AddTicks(2888),
                            IsActive = true,
                            Name = "Member"
                        });
                });
