...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20251223205851_RenameUserIdToAssigneeId")]
    partial class RenameUserIdToAssigneeId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 12, 23, 23, 58, 50, 854, DateTimeKind.Local).AddTicks(4058),
                            IsActive = true,
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            Code = "EDITOR",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 12, 23, 23, 58, 50, 854, DateTimeKind.Local).AddTicks(4067),
                            IsActive = true,
                            Name = "Editor"
                        },
                        new
                        {
                            ...
                            Code = "MEMBER",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2025, 12, 23, 23, 58, 50, 854, DateTimeKind.Local).AddTicks(4068),
                            IsActive = true,
                            Name = "Member"
                        });
                });
