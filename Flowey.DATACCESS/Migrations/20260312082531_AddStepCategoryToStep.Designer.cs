...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20260312082531_AddStepCategoryToStep")]
    partial class AddStepCategoryToStep
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.TaskLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.TaskLink", b =>
                {
                    b.HasOne("Flowey.DOMAIN.Model.Concrete.Task", "SourceTask")
                        .WithMany("OutgoingLinks")
                        .HasForeignKey("SourceTaskId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Flowey.DOMAIN.Model.Concrete.Task", "TargetTask")
