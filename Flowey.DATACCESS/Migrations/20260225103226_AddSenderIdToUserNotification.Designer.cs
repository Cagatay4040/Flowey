...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20260225103226_AddSenderIdToUserNotification")]
    partial class AddSenderIdToUserNotification
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 2, 25, 13, 32, 26, 229, DateTimeKind.Local).AddTicks(9014),
                            IsActive = true,
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            Code = "EDITOR",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 25, 13, 32, 26, 229, DateTimeKind.Local).AddTicks(9025),
                            IsActive = true,
                            Name = "Editor"
                        },
                        new
                        {
                            ...
                            Code = "MEMBER",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 25, 13, 32, 26, 229, DateTimeKind.Local).AddTicks(9026),
                            IsActive = true,
                            Name = "Member"
                        });
                });
