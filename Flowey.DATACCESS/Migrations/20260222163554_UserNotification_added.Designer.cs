...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20260222163554_UserNotification_added")]
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 2, 22, 19, 35, 54, 703, DateTimeKind.Local).AddTicks(1947),
                            IsActive = true,
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            Code = "EDITOR",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 22, 19, 35, 54, 703, DateTimeKind.Local).AddTicks(1955),
                            IsActive = true,
                            Name = "Editor"
                        },
                        new
                        {
                            ...
                            Code = "MEMBER",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 22, 19, 35, 54, 703, DateTimeKind.Local).AddTicks(1956),
                            IsActive = true,
                            Name = "Member"
                        });
                });
