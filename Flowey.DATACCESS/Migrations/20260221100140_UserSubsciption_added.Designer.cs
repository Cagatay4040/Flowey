...
namespace Flowey.DATACCESS.Migrations
{
    ...
    [Migration("20260221100140_UserSubsciption_added")]
    partial class UserSubsciption_added
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowey.DOMAIN.Model.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2026, 2, 21, 13, 1, 39, 937, DateTimeKind.Local).AddTicks(7959),
                            IsActive = true,
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            Code = "EDITOR",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 21, 13, 1, 39, 937, DateTimeKind.Local).AddTicks(7966),
                            IsActive = true,
                            Name = "Editor"
                        },
                        new
                        {
                            ...
                            Code = "MEMBER",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2026, 2, 21, 13, 1, 39, 937, DateTimeKind.Local).AddTicks(7967),
                            IsActive = true,
                            Name = "Member"
                        });
                });
